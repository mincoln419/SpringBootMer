...
@SequenceGenerator(name = "LW_SQ_ID_GENERATOR", sequenceName = "LW_SQ_ID_GENERATOR", initialValue = 1, allocationSize = 1)
public class LawDomain extends CommonEmbeded{

	@Id @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "LW_SQ_ID_GENERATOR")
